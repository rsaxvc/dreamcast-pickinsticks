 ...
 *
 *   The adventures of a brown bear running through
 *   his forest, gathering hamburgers and
 *   avoiding obstacles.
 *
 */
...
void phase_gameplay() {
	while( 1 ) {		
		...
		int hasLost = gamelogic_hasLost( player_getCollisionBox() );
		if( hasLost ) {
			p_lostDelay--;
		}
    }
